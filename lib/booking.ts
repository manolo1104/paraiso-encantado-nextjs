...
// Maps suite page id → BOOKING_ROOM id (for auto-select from /habitaciones/[id])
export const SUITE_ID_TO_ROOM_ID: Record<string, number> = {
  'flor-de-liz-1':  1,
  'flor-de-liz-2':  2,
  'lindavista':     3,
  'jungla':         4,
...
// ── Categorías por VISTA (3 grupos) ──────────────────────
// El grupo (categoryGroup) define la vista; el spa/tipo es un distintivo aparte.
export const VIEW_MONTANAS = 'Vista a las Montañas';
export const VIEW_JARDINES = 'Vista a los Jardines';
export const VIEW_PISCINA  = 'Vista a la Piscina';
export const VIEW_ORDER = [VIEW_MONTANAS, VIEW_JARDINES, VIEW_PISCINA];
...
export const BOOKING_ROOMS: BookingRoom[] = [
  {
    ...
    price: 2000,
    priceTiers: { 2: 2000, 3: 2500, 4: 2500 },
    categoryGroup: VIEW_MONTANAS,
    category: 'Suite con spa privado',
    image: '/images/FLOR DE LIS 1/PORTADA.jpg',
    images: ['/images/FLOR DE LIS 1/PORTADA.jpg', '/images/FLOR DE LIS 1/DSCF1191.jpg', '/images/FLOR DE LIS 1/DSCF1312.jpeg', '/images/FLOR DE LIS 1/Copia de DSC09450-2.jpg', '/images/FLOR DE LIS 1/Copia de DSC09677-HDR.jpg'],
    features: ['2 Camas matrimoniales', 'Baño completo', 'WiFi', 'Terraza con vista', 'Spa privado', 'Aire acondicionado'],
    attributes: { wifi: true, kingBed: false, balcony: true,  jacuzzi: false, spaPrivado: true  },
    maxGuests: 4,
    occupancy: 'MEDIUM',
  },
  {
    ...
    images: ['/images/FLOR DE LIS 2/PORTADA.jpeg', '/images/FLOR DE LIS 2/Copia de FDL2.jpg', '/images/FLOR DE LIS 2/DSCF1191.jpg', '/images/FLOR DE LIS 2/Copia de DSC09450-2.jpg', '/images/FLOR DE LIS 2/Copia de DSC09677-HDR.jpg'],
    features: ['2 Camas matrimoniales', 'Baño completo', 'WiFi', 'Terraza con vista', 'Spa privado', 'Aire acondicionado'],
    attributes: { wifi: true, kingBed: false, balcony: true,  jacuzzi: false, spaPrivado: true  },
    maxGuests: 4,
    occupancy: 'HIGH',
  },
  {
    ...
    image: '/images/LINDAVISTA/PORTADA.jpg',
    images: ['/images/LINDAVISTA/PORTADA.jpg', '/images/LINDAVISTA/Copia de DSC09539-HDR.jpg', '/images/LINDAVISTA/Copia de DSC09569.jpg', '/images/LINDAVISTA/Copia de DSC09576.jpg', '/images/LINDAVISTA/Copia de IMG_0531.jpg'],
    features: ['1 Cama kingsize', '1 Cama matrimonial', 'Tina de hidromasaje', 'Terraza privada', 'WiFi', 'Vista montaña', 'Aire acondicionado'],
    attributes: { wifi: true, kingBed: true,  balcony: true,  jacuzzi: true,  spaPrivado: false },
    maxGuests: 4,
    occupancy: 'LOW',
  },
  {
    ...
    images: ['/images/JUNGLA/PORTADA.JPG', '/images/JUNGLA/DSCF1065.jpg', '/images/JUNGLA/DSCF1078.jpg', '/images/JUNGLA/DSCF1094.jpg', '/images/JUNGLA/Copia de DSCF1085.jpg', '/images/JUNGLA/Copia de DSCF1088.jpg'],
    features: ['1 Cama kingsize', '1 Cama matrimonial', 'Terraza privada', 'Spa privado', 'Vista montaña', 'WiFi', 'Aire acondicionado'],
    attributes: { wifi: true, kingBed: true,  balcony: true,  jacuzzi: false, spaPrivado: true  },
    maxGuests: 4,
    occupancy: 'MEDIUM',
  },
  {
    ...
    images: ['/images/LAJAS/PORTADA.jpg', '/images/LAJAS/Copia de DSC09589-HDR.jpg', '/images/LAJAS/Copia de DSC09610-HDR.jpg', '/images/LAJAS/Copia de DSC09615.jpg', '/images/LAJAS/Copia de DSC09622-2.jpg'],
    features: ['2 Camas matrimoniales', 'Sala de estar', '2 Baños completos', 'Terraza privada', 'WiFi', 'Aire acondicionado'],
    attributes: { wifi: true, kingBed: false, balcony: true,  jacuzzi: false, spaPrivado: false },
    maxGuests: 4,
    occupancy: 'LOW',
  },
  {
    ...
    category: 'Habitación',
    image: '/images/LIRIOS 1/PORTADA.jpg',
    images: ['/images/LIRIOS 1/PORTADA.jpg', '/images/LIRIOS 1/Copia de DSC09524-HDR.jpg', '/images/LIRIOS 1/Copia de DSCF1620.jpg', '/images/LIRIOS 1/Copia de DSCF1622.jpg'],
    features: ['2 Camas matrimoniales', 'Vista jardín y selva', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: false, balcony: false, jacuzzi: false, spaPrivado: false },
    maxGuests: 4,
    occupancy: 'LOW',
  },
  {
    ...
    categoryGroup: VIEW_JARDINES,
    category: 'Habitación',
    image: '/images/LIRIOS 2/PORTADA.jpg',
    images: ['/images/LIRIOS 2/PORTADA.jpg', '/images/LIRIOS 2/Copia de DSC09483-HDR.jpg', '/images/LIRIOS 2/Copia de DSC09489-2.jpg'],
    features: ['Balcón privado con vista jardines', '2 Camas matrimoniales', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: false, balcony: true,  jacuzzi: false, spaPrivado: false },
    maxGuests: 4,
    occupancy: 'MEDIUM',
  },
  {
    ...
    image: '/images/ORQUIDEAS 2/PORTADA.jpg',
    images: ['/images/ORQUIDEAS 2/PORTADA.jpg', '/images/ORQUIDEAS 2/Copia de DSC09568-HDR.jpg', '/images/ORQUIDEAS 2/DSCF1607.jpg'],
    features: ['Cama kingsize', 'Terraza con vista a piscina', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: true,  balcony: true,  jacuzzi: false, spaPrivado: false },
    maxGuests: 2,
    occupancy: 'MEDIUM',
  },
  {
    ...
    images: ['/images/ORQUIDEAS DOBLE/PORTADA.jpg', '/images/ORQUIDEAS DOBLE/Copia de DSC09602-HDR.jpg', '/images/ORQUIDEAS DOBLE/Copia de DSCF1607.jpg', '/images/ORQUIDEAS DOBLE/Copia de DSCF1616.jpg', '/images/ORQUIDEAS DOBLE/Copia de DSCF1617.jpg', '/images/ORQUIDEAS DOBLE/DSCF1607.jpg'],
    features: ['2 Camas matrimoniales', 'Terraza con vista a piscina', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: false, balcony: true,  jacuzzi: false, spaPrivado: false },
    maxGuests: 4,
    occupancy: 'HIGH',
  },
  {
    ...
    categoryGroup: VIEW_PISCINA,
    category: 'Habitación King',
    image: '/images/ORQUIDEAS 3/PORTADA.jpg',
    images: ['/images/ORQUIDEAS 3/ORQUIDEAS_3_HERO.jpg', '/images/ORQUIDEAS 3/PORTADA.jpg', '/images/ORQUIDEAS 3/Copia de DSC09567-HDR.jpg', '/images/ORQUIDEAS 3/Copia de DSC09568-HDR.jpg', '/images/ORQUIDEAS 3/DSCF1607.jpg', '/images/ORQUIDEAS 3/DSCF1612.jpg'],
    features: ['Cama kingsize', 'Terraza con vista a piscina', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: true,  balcony: true,  jacuzzi: false, spaPrivado: false },
    maxGuests: 2,
    occupancy: 'HIGH',
  },
  {
    ...
    categoryGroup: VIEW_PISCINA,
    category: 'Habitación',
    image: '/images/BROMELIAS 1/PORTADA.jpg',
    images: ['/images/BROMELIAS 1/PORTADA.jpg', '/images/BROMELIAS 1/Copia de DSC09385-HDR.jpg', '/images/BROMELIAS 1/Copia de DSC09419-HDR.jpg', '/images/BROMELIAS 1/Copia de DSC09431.jpg'],
    features: ['2 Camas matrimoniales', 'Planta baja', 'Acceso directo piscina', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: false, balcony: false, jacuzzi: false, spaPrivado: false },
    maxGuests: 4,
    occupancy: 'LOW',
  },
  {
    ...
    price: 1900,
    priceTiers: { 2: 1900, 3: 2400, 4: 2400, 5: 2700, 6: 3000 },
    categoryGroup: VIEW_PISCINA,
    category: 'Suite familiar',
    image: '/images/HELECHOS 1/PORTADA.jpg',
    images: ['/images/HELECHOS 1/PORTADA.jpg', '/images/HELECHOS 1/Copia de DSC09461-HDR 2.jpg', '/images/HELECHOS 1/Copia de DSC09516-HDR.jpg', '/images/HELECHOS 1/Copia de DSC09517-HDR.jpg', '/images/HELECHOS 1/Copia de DSC09526-HDR.jpg'],
    features: ['3 Camas matrimoniales', 'Terraza con vista a piscina', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: false, balcony: false, jacuzzi: false, spaPrivado: false },
    maxGuests: 6,
    occupancy: 'MEDIUM',
  },
  {
    ...
    categoryGroup: VIEW_PISCINA,
    category: 'Suite familiar',
    image: '/images/HELECHOS 2/PORTADA.jpg',
    images: ['/images/HELECHOS 2/PORTADA.jpg', '/images/HELECHOS 2/Copia de DSC09461-HDR.jpg', '/images/HELECHOS 2/Copia de DSC09556-HDR.jpg'],
    features: ['4 Camas matrimoniales', 'Terraza con vista a piscina', 'Baño completo', 'Aire acondicionado', 'WiFi'],
    attributes: { wifi: true, kingBed: false, balcony: false, jacuzzi: false, spaPrivado: false },
    maxGuests: 6,
    occupancy: 'HIGH',
  },
...
// ── Add-ons del checkout ─────────────────────────────────
// Desayuno americano: precio por persona por noche (adultos + menores). El mismo
...
// Qué compra el huésped con la cancelación flexible. Se muestra en el checkout y
// en el correo: si cambia la regla, cambia solo aquí.
export const CANCELACION_FLEX_REGLA = 'Cancela hasta 24 horas antes de tu llegada y te devolvemos el 100% de lo pagado.';
export const CANCELACION_FLEX_CORTO = 'Reembolso 100% hasta 24 h antes';
...
export function calcAddonTotals(
  addons: BookingAddons | undefined,
  personas: number,
  nights: number,
  stayBase: number,
): AddonTotals {
...
export interface StayTotals {
  subtotal: number;      // habitaciones
  discount: number;
  addons: AddonTotals;
  total: number;         // lo que cuesta la estancia completa
  deposit: number;       // lo que se cobra hoy
  pending: number;
  isDeposit: boolean;
}
