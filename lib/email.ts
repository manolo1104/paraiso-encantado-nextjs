            ...
            <tr><td class="mobile-padding" style="padding:24px 48px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr><td colspan="2" style="padding-top:14px;border-top:1px solid rgba(201,185,154,0.25);">
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td><p style="margin:0;font-family:'Jost','Helvetica Neue',Arial;font-size:11px;color:#c9b99a;">— Anticipo recibido</p></td>
                      <td style="text-align:right;"><p style="margin:0;font-family:'Jost','Helvetica Neue',Arial;font-size:13px;font-weight:500;color:#7ecf86;">$${Number(data.anticipo||0).toLocaleString('es-MX')} MXN</p></td>
                    </tr>
                    <tr>
                      <td><p style="margin:6px 0 0;font-family:'Jost','Helvetica Neue',Arial;font-size:11px;color:#f0b97a;">Saldo pendiente</p></td>
                      <td style="text-align:right;"><p style="margin:6px 0 0;font-family:'Jost','Helvetica Neue',Arial;font-size:13px;color:#f0b97a;">$${Math.max(0,Number(data.total||0)-Number(data.anticipo||0)).toLocaleString('es-MX')} MXN</p></td>
                    </tr>
                  </table>
                </td></tr>` : ''}
