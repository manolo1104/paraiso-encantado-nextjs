        ...
        <aside className={styles.detail}>
          ...
          <div className={styles.priceCard}>
            ...
            <div className={styles.priceTiers}>
              <span>2 personas: <strong>${suite.priceTiers[2].toLocaleString('es-MX')}</strong></span>
              {price3 && (
                <span>3 personas: <strong>${price3.toLocaleString('es-MX')}</strong></span>
              )}
              {price4 && price4 !== price3 && (
                <span>4 personas: <strong>${price4.toLocaleString('es-MX')}</strong></span>
              )}
              {price3 && price4 && price4 === price3 && (
                <span>3–4 personas: <strong>${price3.toLocaleString('es-MX')}</strong></span>
              )}
            ...
            .map((s) => (
              <Link key={s.id} href={`/habitaciones/${s.id}`} className={styles.otherCard}>
                ...
                <div className={styles.otherContent}>
                  <h3>{s.name}</h3>
                  <p>Desde ${s.price.toLocaleString('es-MX')} MXN/noche</p>
                </div>
              </Link>
            ))}
        </div>
